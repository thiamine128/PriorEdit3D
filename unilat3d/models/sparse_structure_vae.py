...
class SparseStructureEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.dtype = torch.float16 if precision == "fp16" else torch.float32 if precision == "fp32" else torch.bfloat16 if precision == "bf16" else None
...
class SparseStructureDecoder(nn.Module):
    ...
    def convert_to_bf16(self) -> None:
        ...
        self.dtype = torch.bfloat16
        self.input_layer.apply(convert_module_to_bf16)
        self.blocks.apply(convert_module_to_bf16)
        self.middle_block.apply(convert_module_to_bf16)
